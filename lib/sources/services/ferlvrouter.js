...
goog.provide( 'zz.app.services.FERLVRouter' );
 ...
 */
zz.app.services.FERLVRouter = function( ){
 ...
 */
zz.app.services.FERLVRouter.prototype.when = function(
	...
	if( goog.DEBUG ){
		...
		goog.asserts.assertFunction(
			...
			'zz.app.services.FERLVRouter#when: ' +
 ...
 * @override
 */
zz.app.services.FERLVRouter.prototype.processRoute = function( config ){
	...
	this.layoutController_.setView( route.viewControllerConstructor );
};