...
zz.app.services.FEViewRouter = function( ){
	...
	/**
	 * DOM-element where View Controller should be
	 * rendered.
	 * @type {Element}
	 * @private
	 */
	this.viewWrapperElement_ = null;
};
goog.inherits(
 ...
 */
zz.app.services.FEViewRouter.prototype.setViewWrapperElement = function( element ){

	goog.asserts.assertElement( element );
	this.viewWrapperElement_ = element;
};
...
zz.app.services.FEViewRouter.prototype.processRoute = function( config ){
	...
	if( !this.viewController_ ||
		...
		this.viewController_.render( this.viewWrapperElement_ );
	}
};
