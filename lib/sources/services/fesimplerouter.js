...
goog.provide( 'zz.app.services.FESimpleRouter' );
 ...
 */
zz.app.services.FESimpleRouter = function( ){
 ...
 * @override
 */
zz.app.services.FESimpleRouter.prototype.processRoute = function( config ){
 ...
 */
zz.app.services.FESimpleRouter.prototype.when = function( route, viewControllerConstructor ){

	if( goog.DEBUG ){

		goog.asserts.assertFunction(
			viewControllerConstructor,
			'zz.app.services.FESimpleRouter#when: ' +
