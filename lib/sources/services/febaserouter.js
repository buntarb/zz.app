...
zz.app.services.FEBaseRouter.prototype.bootstrap = function( ){
	...
	// TODO (buntarb): /#/ - hardcoded!
	this.currentFragment_ = this.history_.getToken( ).length ?
		this.history_.getToken( ) :
		'/#/';
	this.setFragment( this.currentFragment_ );
