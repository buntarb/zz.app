...
goog.provide( 'zz.app.services.FELayoutRouter' );
 ...
 */
zz.app.services.FELayoutRouter = function( ){
 ...
 */
zz.app.services.FELayoutRouter.prototype.when = function(
	...
	if( goog.DEBUG ){
		...
		goog.asserts.assertFunction(
			...
			'zz.app.services.FELayoutRouter#when: ' +
 ...
 * @override
 */
zz.app.services.FELayoutRouter.prototype.processRoute = function( config ){
	...
	this.layoutController_.setView( config.viewControllerConstructor );
};