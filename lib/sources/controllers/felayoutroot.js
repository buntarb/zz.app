...
goog.provide( 'zz.app.controllers.FELayoutRoot' );
 ...
 */
zz.app.controllers.FELayoutRoot = function( model, view, opt_rootElement ){

    goog.base( this, model, view, opt_rootElement );
};
goog.inherits(
    zz.app.controllers.FELayoutRoot,
 ...
 * @return {Element}
 */
zz.app.controllers.FELayoutRoot.prototype.getLayoutWrapper = function( ){
