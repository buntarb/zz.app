 ...
 * @param {zz.views.FEBase} view
 */
zz.app.controllers.FEBaseLayout.prototype.setView = function( view ){
 ...
 * @param {zz.views.FEBase} view
 */
zz.app.controllers.FEBaseLayout.prototype.setViewInternal = function( view ){

    this.addChild( view, false );
    view.render( this.getViewWrapper( ) );
};
